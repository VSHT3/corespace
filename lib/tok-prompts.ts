...
export const TOK_PROMPTS: Record<number, TOKPrompt> = {
  ...
  15: {
    ...
    description: "Our capability to obtain knowledge is limited by many factors — psychological, ethical, physical. How does being human impact our ability to pursue certain forms of knowledge?",
  },
  16: {
    title: "Should some knowledge not be sought on ethical grounds?",
    description: "Ethics are one of the most challenging parts of the TOK knowledge framework. What would prevent you from gaining certain information — respect for privacy, dignity? What are the consequences of seeking knowledge without regard for someone else's well-being?",
  },
  17: {
  ...
  20: {
    ...
    description: "Personal experience can be a source of knowledge, but it also shapes how we view and accept facts. Have you ever questioned the reliability of a claim based on your personal history with a situation — a description of a past event, a political statement?",
  },
  21: {
    title: "What is the relationship between knowledge and culture?",
    description: "Shared knowledge forms a significant part of culture — but does the culture of a community influence how they accept or interpret knowledge? What shared beliefs or values in your society shape how you view the world?",
  },
  22: {
  ...
  23: {
    ...
    description: "Knowledge is produced not only through words and texts but also through physical objects — limited by their physical properties (e.g. measurement uncertainty). Identify the tools used in different areas (scientists, historians, mathematicians) and discuss their impact on knowledge acquisition.",
  },
  24: {
    title: "How might the context in which knowledge is presented influence whether it is accepted or rejected?",
    description: "Should our acceptance of knowledge depend on its presentation? What contexts increase the chance of acceptance — types of texts, expert speeches, advertisements?",
  },
  25: {
  ...
  26: {
    ...
    description: "Producing knowledge is often collaborative — group projects, lab work. It also shapes how we understand and rely on knowledge. How do interactions with teachers, peers, or strangers change our perception of certain information?",
  },
  27: {
