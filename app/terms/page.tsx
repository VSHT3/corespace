    ...
    <main className="page-main" style={{ maxWidth: "680px" }}>
      ...
      <div style={{ color: "#333", fontSize: "14px", lineHeight: "1.8" }} className="space-y-6">
        <section>
          ...
          <p>Corespace is a study tool for International Baccalaureate Diploma students. It provides AI-assisted guidance for Theory of Knowledge, CAS, and Extended Essay components. It is not affiliated with or endorsed by the International Baccalaureate Organisation.</p>
        </section>
        ...
        <section>
          ...
          <p>Use Corespace to support your own learning. Do not:</p>
        ...
        <section>
          ...
          <p>Feedback and suggestions from Corespace are generated by AI and may contain errors. Do not treat them as authoritative IB guidance. Always verify with your teacher or coordinator.</p>
        </section>
        ...
        <section>
          ...
          <p>Corespace is provided as-is. We are not liable for IB assessment outcomes, data loss due to circumstances outside our control, or indirect damages. Our liability is limited to the amount you paid us in the past 12 months.</p>
        </section>
        ...
        <section>
          ...
          <p><a href="mailto:hello@corespace.app" style={{ color: "var(--fg)" }}>hello@corespace.app</a></p>
        </section>
