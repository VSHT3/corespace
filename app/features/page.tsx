...
const features = [
  {
    ...
    bullets: [
      ...
      "AI justification generator: 3–4 sentence draft specific to your object and prompt",
      "AI knowledge question generator: 3 IB-style KQs with rationale for each",
      "AI scoring (1–10) with strength, weakness, and actionable tip",
      "In-card AI refinement chat to iterate your justification",
      "Word count targets (95–150 per justification, 950 total) with live indicators",
      "Print-optimised export: hides UI chrome, preserves all content",
      "Multiple exhibitions: create, duplicate, delete, reorder objects",
    ],
  },
  {
