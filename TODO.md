...
## General — AI
- [ ] **AI usage tracking** — track AI usage per user and plan (free/student/school) to display progress towards plan limits.
- [ ] **AI usage reset** — reset AI usage counter at the start of each month.
- [ ] **AI fallback to google gemini once vercel AI gateway is drained** — 
- [ ] TOK exhibitions -- do some training or whatever
